              ...
              {filtered.map(lead => {
                ...
                return (
                  <tr key={lead.id} onClick={()=>openLead(lead)} style={{cursor:'pointer'}}
                    ...
                    <td style={{...S.td,fontWeight:500,fontSize:11}}>
                      <a href={'/contractor/projects/'+lead.id} onClick={function(e){e.stopPropagation()}} style={{color:'#FF8C00',textDecoration:'none'}}>
                        {lead.pn}
                      </a>
