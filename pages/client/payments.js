...
var MILESTONES = [
  {
    ...
    pct:    10,
    desc:   'Due upon signing the project agreement. Reserves your spot on the schedule.',
    status: 'paid',
  },
  {
    num:    2,
    label:  'Pre-Construction / Permit Pull',
    pct:    15,
    desc:   'Due before demolition begins. Covers permit fees, design finalizations, and materials ordering.',
    status: 'paid',
  },
  {
    num:    3,
    label:  'Framing & Rough-Ins Complete',
    pct:    25,
    desc:   'Due upon completion of structural framing, rough electrical, plumbing, and HVAC.',
    status: 'pending',
  },
  {
    num:    4,
    label:  'Drywall & Finishes Started',
    pct:    25,
    desc:   'Due upon installation of insulation, drywall, and start of finish work.',
    status: 'upcoming',
  },
  {
    num:    5,
