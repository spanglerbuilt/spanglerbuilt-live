const PHASES = ['Pre-construction','Demo & framing','Drywall & rough-ins','Paint & flooring','Closeout']
const NAV = [
...
export default function ClientDashboard() {
  var phaseNum = 1
  var phasePct = Math.round((phaseNum / 5) * 100)
  return (
    <div style={{minHeight:'100vh',background:'#f5f4f1',fontFamily:'sans-serif'}}>
      <div style={{background:'#002147',padding:'1rem 2rem',display:'flex',alignItems:'center',justifyContent:'space-between',borderBottom:'3px solid #FF8C00'}}>
        ...
        <div style={{display:'flex',gap:12,alignItems:'center'}}>
          <span style={{fontSize:11,color:'rgba(255,255,255,.6)'}}>Ryan and Dori Mendel</span>
          <a href="/login" style={{fontSize:11,color:'#FF8C00',textDecoration:'none',border:'1px solid #FF8C00',padding:'3px 10px',borderRadius:3}}>Sign out</a>
        </div>
      </div>
      <div style={{maxWidth:900,margin:'0 auto',padding:'1.5rem'}}>
        <div style={{background:'#002147',borderRadius:4,padding:'1.25rem 1.5rem',marginBottom:'1.25rem',borderLeft:'4px solid #FF8C00'}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',flexWrap:'wrap',gap:8}}>
            <div>
              <div style={{fontFamily:'Georgia,serif',fontSize:20,color:'#fff',marginBottom:4}}>Welcome, Ryan and Dori</div>
