export default function Dashboard() {
  var modules = [
    ...
    {label:'Client portal',      href:'/client/dashboard',     desc:'View client side',            icon:'✓'},
  ]
  var pipeline = [
    ...
    <div style={{minHeight:'100vh',background:'#f5f4f1',fontFamily:'sans-serif'}}>
      <div style={{background:'#002147',padding:'1rem 2rem',display:'flex',alignItems:'center',justifyContent:'space-between',borderBottom:'3px solid #FF8C00'}}>
        ...
        <div style={{display:'flex',gap:16,alignItems:'center'}}>
          ...
          <a href="/login" style={{fontSize:11,color:'#FF8C00',textDecoration:'none',border:'1px solid #FF8C00',padding:'4px 12px',borderRadius:3}}>Sign out</a>
        </div>
      </div>
