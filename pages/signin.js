export default function SignIn() {
  return (
    <div style={{minHeight:'100vh',background:'#0a0a0a',display:'flex',alignItems:'center',justifyContent:'center',padding:'1rem',fontFamily:'Poppins,sans-serif'}}>
      <div style={{background:'#161616',border:'3px solid #D06830',maxWidth:420,width:'100%',padding:'2.5rem',borderRadius:4}}>
        ...
        <a href="/api/auth/signin/google" style={{width:'100%',display:'flex',alignItems:'center',justifyContent:'center',gap:10,background:'#0a0a0a',color:'#fff',padding:'14px 16px',fontSize:13,fontWeight:600,textDecoration:'none',borderRadius:3,marginBottom:'1rem'}}>
        ...
        <div style={{margin:'1rem 0',display:'flex',alignItems:'center',gap:10}}>
          ...
          <span style={{fontSize:11,color:'rgba(255,255,255,.35)'}}>or quick access</span>
          <div style={{flex:1,height:1,background:'rgba(255,255,255,.08)'}}/>
        </div>
        ...
        <p style={{fontSize:10,color:'rgba(255,255,255,.35)',textAlign:'center',lineHeight:1.8,margin:0}}>
          ...
          <a href="tel:4044927650" style={{color:'#D06830',textDecoration:'none'}}>Questions? (404) 492-7650</a>
        </p>
      </div>
