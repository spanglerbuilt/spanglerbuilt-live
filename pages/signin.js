    ...
    <div style={{minHeight:'100vh',background:'#002147',display:'flex',alignItems:'center',justifyContent:'center',padding:'1rem',fontFamily:'sans-serif'}}>
      <div style={{background:'#fff',border:'3px solid #FF8C00',maxWidth:420,width:'100%',padding:'2.5rem',borderRadius:4}}>
        ...
        <div style={{display:'flex',gap:8,marginBottom:'1.5rem'}}>
          <a href="/dashboard" style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',background:'#002147',color:'#FF8C00',padding:'10px',fontSize:11,fontWeight:700,textDecoration:'none',borderRadius:3,textTransform:'uppercase'}}>Contractor</a>
          <a href="/client/dashboard" style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',background:'#f5f4f1',color:'#002147',padding:'10px',fontSize:11,fontWeight:700,textDecoration:'none',borderRadius:3,textTransform:'uppercase',border:'1px solid #e8e6e0'}}>Client</a>
        </div>
