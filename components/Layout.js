...
var NAV = {
  contractor: [
    ...
    { href: '/contractor/contracts',     label: 'Contracts',      icon: '✦' },
    { href: '/contractor/contract-template', label: 'Contract Templates', icon: '◈' },
  ...
  client: [
    ...
    { href: '/client/sign-contract',   label: 'Sign Contract',  icon: '✍' },
