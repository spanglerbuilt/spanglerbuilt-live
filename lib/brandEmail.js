  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:${BRAND.dark};padding:32px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
        ...
        <!-- ── HEADER ── -->
        <tr><td style="background:${BRAND.header};border-top:4px solid ${BRAND.orange};border-radius:8px 8px 0 0;padding:28px 36px 24px;">
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="vertical-align:middle;">
                <img src="${BRAND.logo}" alt="SpanglerBuilt Inc." width="140" style="display:block;height:auto;max-width:140px;" onerror="this.style.display='none'">
              </td>
              <td style="vertical-align:middle;text-align:right;">
                <p style="margin:0;font-size:9px;font-weight:700;color:${BRAND.orange};letter-spacing:.18em;text-transform:uppercase;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">Client Portal</p>
                <p style="margin:3px 0 0;font-size:9px;color:rgba(255,255,255,.3);font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">${BRAND.website.replace('https://','')}</p>
              </td>
            </tr>
          </table>
          ${title ? `<p style="margin:20px 0 0;font-size:22px;font-weight:800;color:#ffffff;letter-spacing:-.02em;line-height:1.25;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">${title}</p>` : ''}
